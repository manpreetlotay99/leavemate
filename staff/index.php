			...
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					...
					<div class="col-md-8">
						...
						<p class="font-18 max-width-600">Leave Mate - Your trusted companion for effortless leave management. Simplify your leave requests, track your time off, and enjoy a stress-free experience with our user-friendly platform. Say hello to efficient leave management!</p>
					</div>
				</div>
			</div>
